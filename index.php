...
<head>
    ...
    <link rel="stylesheet" href="snoow.css">
</head>
...
<body>
    ...
    <div class="top-navbar">
        ...
        <div class="navbar-container">
            <ul class="navbar">
                ...
                <li>
                    <a href="../TCC_SNOW/tecnicas/tecnicas.php">
                        <i class="fas fa-hands-helping"></i>
                        <span>Técnicas</span>
                    </a>
                </li>
                <li>
                    <a href="../TCC_SNOW/historicoUsuario/graficos.php">
                        <i class="fas fa-chart-line"></i>
                        <span>Histórico</span>
                    </a>
                </li>
                <li>
                    <a href="../TCC_SNOW/feedbackUsuario/feedback.php">
    ...
    <div class="main-login">
        <div class="left-login">
            <img src="" class="right-login-image">
        </div>
        <div class="right-login"></div>
        <div class="card-login">
            <img src="" class="left-login-image">
        </div>
    </div>
