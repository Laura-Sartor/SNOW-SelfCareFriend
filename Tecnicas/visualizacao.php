...
<head>
    ...
    <title>Técnicas de Visualização - SNOW</title>
    ...
    <style>
        ...
        * {
        ...
        .user-avatar {
            ...
            height: 30px;
            border-radius: 50%;
            background: linear-gradient(135deg, #dbdb34ff, #2980b9);
            display: flex;
            align-items: center;
            justify-content: center;
            color: white;
...
<div class="main-content">
    <div class="container">
        <h3 class="section-subheading">- Técnicas de Visualização -</h3>
        <h1>Técnicas Disponíveis</h1>
        
        <div class="grid-container">
            <?php
            // Buscar técnicas de visualização (categoria 'V')
            $result = $conn->query("SELECT * FROM tecnicas WHERE categoria = 'V' ORDER BY data_criacao DESC");
                ...
                <div class="card">
                    <div class="video-container">
                        <img src="<?php echo $thumbnail_url; ?>" 
                             ...
                             onclick="abrirDetalhes(<?php echo $tecnica['id_tecnicas']; ?>, '<?php echo htmlspecialchars($tecnica['nome']); ?>', '<?php echo htmlspecialchars($tecnica['descricao']); ?>', '<?php echo $embed_url; ?>')">
                    </div>
            ...
            <?php
                ...
                echo '<p style="color: white; text-align: center; grid-column: 1 / -1;">Nenhuma técnica de visualização disponível.</p>';
            }
...
<div id="modalDetalhes" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-buttons">
            <button class="card-button" onclick="entrarTelaCheia()" id="btnTelaCheia">Assistir em Tela Cheia</button>
        </div>
    </div>
</div>
...
<script>
    ...
    function abrirDetalhes(id, nome, descricao, embedUrl) {
        ...
        // Adicionar parâmetros de autoplay se desejar
        const videoUrl = embedUrl + '?autoplay=0';
        document.getElementById('videoTecnica').src = videoUrl;
        document.getElementById('videoTelaCheia').src = videoUrl;
    ...
    function entrarTelaCheia() {
        ...
        // Atualizar para autoplay na tela cheia se desejar
        const videoTelaCheia = document.getElementById('videoTelaCheia');
        const currentSrc = videoTelaCheia.src.split('?')[0];
    ...
    function sairTelaCheia() {
        ...
        // Pausar vídeo (não é possível pausar iframe do YouTube via JS por questões de segurança)
        const videoTelaCheia = document.getElementById('videoTelaCheia');
        const currentSrc = videoTelaCheia.src.split('?')[0];
        videoTelaCheia.src = currentSrc; // Remove autoplay
    }

    // Fechar modal
    function fecharModal() {
        // Limpar src dos iframes para parar os vídeos
        document.getElementById('videoTecnica').src = '';
        document.getElementById('videoTelaCheia').src = '';
    ...
    // Funções para menu do usuário - ATUALIZADAS
