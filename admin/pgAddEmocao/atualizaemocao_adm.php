...
$sql = "UPDATE emocao SET 
                        id_emocao ='$id_emocao',
                        nome ='$nome',
                        icone ='$icone'
                        WHERE id_emocao = $id_emocao";
...
<script>
    // Mostrar mensagem imediatamente e redirecionar
    alert('✅ Emoção atualizada com sucesso!');
    window.location.href = "../pgEmocoes/listaemocao_adm.php";
</script>
