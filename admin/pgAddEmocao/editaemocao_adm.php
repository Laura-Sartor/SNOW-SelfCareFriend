...
<body>
    <table border="2" align="center">
        <form action="atualizaemocao_adm.php" method="post">
            <tr>
                <th colspan="2" align="center">Emoção</th>
            </tr>
        ...
        <tr>
            <th>Ícone</th>
            <td><input type="file" name="icone" value='<?php echo $linha['icone'];}?>'></td>
        </tr>
