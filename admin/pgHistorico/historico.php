...
<head>
    ...
    <title>Controle Histórico - SNOW</title>
</head>
<body>
    <style>
    .top-navbar {
   ...
   <script>
    ...
    <table border="2" align="center">
        <form action="historicoadm.php" method="post">
            <tr>
                <th colspan="2" algin="center">Histórico</th>
            </tr>
            ...
            <td><select name='nome'>
                ...
                <option value='<?php echo $linha['id_emocao'];?>'>
                    <?php echo $linha['nome']; }?></option> </select>
