...
<head>
    ...
    <title>Adcionar Técnica - SNOW</title>
</head>
<body>
...
.user-menu-divider {
    ...
    margin-top: -40px;
    position: relative;
    right: -1400px; /* EMPURRA PARA DIREITA */
}
...
<div class="page-header">
    <h1>Gerenciar Técnicas</h1>
    <a href="../pgAddTec/addtecc_esse.php">
...
<div class="cards-wrapper">
    <div class="cards-title"><i class="fas fa-spa"></i> Lista de técnicas cadastradas</div>
    ...
    <div class="cards-container">
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p class="card-description"><?php echo $linha['descricao']; ?></p>
                <div class="card-meta">
                    <span class="card-badge"><?php echo $linha['categoria']; ?></span>
                    <span class="card-info"><i class="fas fa-clock"></i> <?php echo $linha['tempo_estimado']; ?></span>
                    <span class="card-info"><i class="fas fa-calendar"></i> <?php echo $linha['data_criacao']; ?></span>
                    <?php if(!empty($linha['video'])): ?>
                    <span class="card-info"><i class="fas fa-video"></i> Video</span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="card-actions">
                <button class="card-action-btn" title="Editar">
                    <a href="editatec_adm.php?id_tecnicas=<?php echo $linha['id_tecnicas']; ?>">
                        <img src="editar.png" alt="Editar">
                    </a>
                </button>
                <button class="card-action-btn delete" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir esta técnica?')">
                    <a href="deletetec_adm.php?id_tecnicas=<?php echo $linha['id_tecnicas']; ?>">
    ...
    <div class="cards-footer">
        Total: <strong id="total-count"><?php echo mysqli_num_rows($res); ?></strong> técnicas cadastradas
    </div>
</div>
