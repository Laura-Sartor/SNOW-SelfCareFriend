...
// CONSULTA - Pega os dados REAIS do banco
$query = mysqli_query($id, "SELECT 
    de.id_diarioemocao,
    de.intensidade,
    de.hora,
    d.descricao,
...
<head>
    ...
    <title>Controle Diário - SNOW</title>
    <style>
...
.user-menu-divider {
    ...
    padding: 20px 0;
    width: 100%;
    margin-top: auto; /* Isso empurra para baixo */
}
...
<body>
    ...
    <div class="top-navbar">
        ...
        <div class="navbar-container">
            <ul class="navbar">
                ...
                <li class="active">
                    <a href="./listadiarioemocao_adm.php">
    ...
    <div class="page-header">
        <h1>Registros de Diário-Emoção</h1>
    </div>

    <div class="cards-wrapper">
        <div class="cards-title"><i class="fas fa-chart-line"></i> Relação Diário-Emoção</div>
            ...
            <?php if ($total > 0): ?>
                ...
                <div class="card">
                    <div class="card-content">
                        <h3 class="card-title"><?php echo $row['emocao_nome'] ?: 'Sem emoção'; ?></h3>
                        <div class="card-meta">
                            ...
                            <?php endif; ?>
                            <?php if($row['data_registro']): ?>
                            <span class="card-info"><i class="fas fa-calendar"></i> <?php echo date('d/m/Y', strtotime($row['data_registro'])); ?></span>
                            <?php endif; ?>
                        </div>
                        <?php if($row['usuario_nome']): ?>
                        <div class="card-meta">
                            <span class="card-info"><i class="fas fa-user"></i> Usuário: <?php echo $row['usuario_nome']; ?></span>
                        </div>
                        <?php endif; ?>
                        <?php if(!empty($row['descricao'])): ?>
                        <div class="card-meta" style="margin-top: 8px;">
                            <span class="card-info"><i class="fas fa-align-left"></i> <?php echo substr($row['descricao'], 0, 80) . (strlen($row['descricao']) > 80 ? '...' : ''); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="card-meta">
                            <span class="card-info">Não há registros de diário-emoção no sistema.</span>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="cards-footer">
            Total: <strong><?php echo $total; ?></strong> registros encontrados
        </div>
    </div>
