...
<head>
    ...
    <title>Controle Feedback - SNOW</title>
</head>
<body>
...
<div class="cards-wrapper">
    <div class="cards-title"><i class="fas fa-comments"></i> Feedbacks Realizados</div>
    ...
    <div class="cards-container">
        ...
        <div class="card">
            <div class="card-content">
                <h3 class="card-title"><?php echo substr($linha['comentario'], 0, 80) . (strlen($linha['comentario']) > 80 ? '...' : ''); ?></h3>
                <div class="card-meta">
                    <span class="card-badge">Avaliação: <?php echo $linha['avaliacao']; ?></span>
                    <span class="card-info"><i class="fas fa-calendar"></i> <?php echo $linha['data_feedback']; ?></span>
                </div>
                <div class="card-meta" style="margin-top: 8px;">
                    <span class="card-info"><i class="fas fa-comment"></i>Feedback #<?php echo $linha['id_feedback']; ?> </span>
                </div>
            </div>
            <div class="card-actions">
                <button class="card-action-btn delete" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir este feedback?')">
                    <a href="deletefeed_adm.php?id_feedback=<?php echo $linha['id_feedback']; ?>">
    ...
    <div class="cards-footer">
        Total: <strong id="total-count"><?php echo mysqli_num_rows($res); ?></strong> feedbacks cadastrados
    </div>
</div>
