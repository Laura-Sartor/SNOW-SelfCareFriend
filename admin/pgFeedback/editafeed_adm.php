...
<body>
    ...
    <table border="2" align="center">
     ...
     <form action="atualizafeed_adm.php" method="post">
        <tr>
            <!--Campo oculto para enviar o ID-->
            <input type="hidden" name="id_feedback" value='<?php echo $linha['id_feedback'];?>'>

            <!-- Título da tabela -->
            <th colspan="2" align="center"> Feedback</th>
        </tr>
        <tr>
            <!--Campo para colocar a data-->
            <th> Data do Feedback: </th>
            <td><input type="date" name="data_feedback" value="<?php echo $linha ['data_feedback']; ?>"></td>
        </tr>
        <tr>
            <!--Campo para digitar o comentário-->
            <th>Comentário:</th>
            <td><input type="text" name="comentario" value="<?php echo $linha ['comentario'];}?>"></td>
        </tr>
        <tr>
            <!--Campo para avaliar -->
            <th>Avaliação:</th>
            <td>
                ...
                <div>
                    <input type="radio" id="mtbom" name="avaliacao" value="mtbom">
