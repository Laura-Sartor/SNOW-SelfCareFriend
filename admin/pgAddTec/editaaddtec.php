...
$id_tecnicas= $_GET['id_tecnicas'];
//Consulta SQL para editar o ID selecionado
$sql = "SELECT * FROM tecnicas WHERE id_tecnicas =".$id_tecnicas;
...
<body>
    ...
    <table border="2" align="center">
        ...
        <form action="atualizaaddtec.php" method="post">

         <tr>
                    <h1 align="center">Adicionar Técnica</h1>
        </tr>
             <tr>
         ...
         <th>
            ...
            <!--Botão de enviar-->
           <tr>
            <th colspan="2" align="center"> <input type="submit" name="cadastrar" class="enviar" ></th>
         </tr>
        </form>
    </table>
</body>
